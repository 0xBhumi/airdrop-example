 ...
 */
function deployContract(factory, chains, bytecode, encodedArgs, formattedSalt) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log('Deploying contract across chains:', chains);
        const tx = yield factory.deployEverywhere(chains, bytecode, encodedArgs, formattedSalt, {
